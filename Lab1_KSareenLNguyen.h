/*****************************************************************************
*                                                                            *
*       Source title:   Lab1_KSareenLNguyen.H
...
// See Lab1_KSareenLNguyen.cpp for the implementation of this class
//
...
#define      PIN_DEFINITION( pinname, pingrpval, site0 ) \
	...
	PIN_DEFINITION (RES_APU, 8192 , 41)	// defines  RES_APU_S0
//}}AFX_ETS_PIN_DEFINITION

//{{AFX_ETS_GROUP_DEFINITION
// Caution:: The following group definitions are filled in by the PinMap Editor
//}}AFX_ETS_GROUP_DEFINITION
class CLab1_KSareenLNguyen : public CTestMain
{
public:
    CLab1_KSareenLNguyen(PRG_FLOW *UserFlow) : CTestMain(UserFlow) {};
    ~CLab1_KSareenLNguyen(){};
...
//  Function body in the Lab1_KSareenLNguyen.cpp file
//
